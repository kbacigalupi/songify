...
Use the `song_rec()` function with a variety of potential inputs to get a single song reccomendation. 
...
Use the `playlist_rec()` function with a variety of potential inputs to get a full playlist reccomednation. 
